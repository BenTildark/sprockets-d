"""
Write a program to ask the user to enter their name and two integers where the second integer is equal to the first integer.
...
Thank you. Please enter the second integer. This integer should be equal to <FirstInteger>:

The user enters the second integer <SecondInteger> at this point.

Your program must output the following:
It is <Answer> that <SecondInteger> is equal to <FirstInteger>.

where <Answer> has a boolean value of true or false based on <SecondInteger>  being equal to  <FirstInteger>
...
Thank you. Please enter the second integer. This integer should be equal to 1: 2
It is False that 2 is equal to 1.
...
"Thank you. Please enter the second integer. This integer should be equal to {}: "
"It is {} that {} is equal to {}."
"""

first_name = input("Please enter your first name: ").capitalize()
first_int = int(input("Hi {}, please enter the first integer: ".format(first_name)))
second_int = int(input("Thank you. Please enter the second integer. This integer should be equal to {}: ".format(first_int)))

bool = first_int == second_int

print("It is {} that {} is equal to {}.".format(bool, second_int, first_int))
