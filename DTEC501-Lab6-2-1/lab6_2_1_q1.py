def mark_problem():
    ...
    The first and last names are too short and therefore they do not meet the minimum requirements and so need to be
    re-entered.
    ...
    while problem:
        ...
        if mark.isnumeric():
            # safe to preform action only if 'mark=num value'
            mark = int(mark)
